...
public class MockAccountDao {
	...
	public ArrayList<Account> getAllAccounts(){
		...
		account1.setAccountId("account3");
		...
		account2.setAccountId("account4");
		...
		account3.setAccountId("account5");
		...
		account4.setAccountId("account6");
		...
		account5.setAccountId("account7");
		...
		account6.setAccountId("account8");
